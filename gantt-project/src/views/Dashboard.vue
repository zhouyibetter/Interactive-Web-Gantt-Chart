  ...
  <div class="py-4 container-fluid">
    <div class="row">
      <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
        <mini-statistics-card title="Today's Money" value="$53,000" :percentage="{
          value: '+505%',
          color: 'text-success',
        }" :icon="{
      ...
      <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
        <mini-statistics-card title="Today's Users" value="2,300" :percentage="{
          value: '+3%',
          color: 'text-success',
        }" :icon="{
      ...
      <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
        <mini-statistics-card title="New Clients" value="+3,462" :percentage="{
          value: '-2%',
          color: 'text-danger',
        }" :icon="{
      ...
      <div class="col-xl-3 col-sm-6 mb-xl-0">
        <mini-statistics-card title="Sales" value="$103,430" :percentage="{
          value: '+5%',
          color: 'text-success',
        }" :icon="{
    ...
    <div class="mt-4 row">
      ...
      <div class="col-lg-7">
        <!-- line chart -->
        <div class="card z-index-2">
          <gradient-line-chart id="chart-line" title="Gradient Line Chart" description="<i class='fa fa-arrow-up text-success'></i>
